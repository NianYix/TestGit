...
def get_list():
    ...
    try:
        url = 'https://bcy.net/tag/492/common/circleFeed?circle_id=492&since='+str(int(time.time()))+'.000000&sort_type=2&grid_type=10'
...
def download(intercepts):
    for i in intercepts:
        ...
        for url in b:
            ...
            with open(r'F:/Work/JerryStudy/Python/ZiLiao/Code/爬取煎蛋网图片/' + str(item_id) + str(index) + '.png', 'wb') as f:
