...
def convert_coor(*arg):
    #print(*arg)
    return string_to_float(arg[0]) + ((string_to_float(arg[1]) + (string_to_float(arg[2].split('/')[0]) / string_to_float(arg[2].split('/')[-1]) / 60)) / 60)
...
if __name__ == '__main__':
    path=r'F:\Work\JerryStudy\Python\ZiLiao\Image\AdresssPhoto.jpg';
    gpsinfo = extract_image(path);
